package com.torneos.equipos.webclient;
    ...
    public String obtenerNombreUsuario(Long usuarioId) {
        return this.webClient.get()
                ...
                .onStatus(HttpStatusCode::is4xxClientError,
                        response -> Mono.error(new RuntimeException("Usuario no encontrado en el sistema")))
                .bodyToMono(JsonNode.class)

                .map(json -> json.get("nombreUsuario").asText())
                .block();
    }
}
